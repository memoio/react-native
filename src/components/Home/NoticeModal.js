...
const NoticeModal = ({ visible, onClose, navigation }) => {
  return (
    <Modal
      animationType="fade"
      transparent={true}
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <Text style={styles.pointsText}>Notice</Text>
          <Text style={styles.messageText}>Please create DID first!</Text>
          <TouchableOpacity
            style={styles.okButton}
            onPress={() => {onClose(); navigation.navigate('AddressApp');}}
          >
            <Text style={styles.okButtonText}>Go</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
