...
const WaitingModal = ({ visible, onClose }) => {
  return (
    <Modal
      animationType="fade"
      transparent={true}
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <Text style={styles.pointsText}>Waiting...</Text>
          <Text style={styles.messageText}>DID id  being created, please wait patiently!</Text>
        </View>
      </View>
    </Modal>
  );
