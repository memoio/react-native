...
const ClaimFailed = ({ visible, onClose,title}) => {
  return (
    <Modal
      animationType="fade"
      transparent={true}
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <Text style={styles.pointsText}>Failed</Text>
          <Text style={styles.messageText}>Please confirm that you have followed MEMO {title}</Text>
          <TouchableOpacity
